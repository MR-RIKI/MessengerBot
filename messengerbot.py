    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            if("search pdf" in msg):
                ...
                reply = "I am from Bangladesh. Currently living in Bogura"
                sendMsg()
                ...
                sendMsg()
            elif ("আসসালামুআলাইকুম" in msg or "আসসালামু আলাইকুম" in msg):
                reply = "Walaikumus Salam😻"
            elif ("Assalamualaikum" in msg or "Assalamu alaikum" in msg):
                reply = "Walaikumus Salamm😻"
                sendMsg()
            elif ("emon" in msg or "Emon" in msg):
             	reply= "ইমন ঘুমাচ্ছে ভাই..!!🥹⛏️"
                sendMsg()
...
cookies = {
    "sb": "GPdaY6tGuetBuNkcYJXPQUeK",
    "fr": "0pShHDR5YVt5VUIco..BjWvcY.th.AAA.0.0.BjWvc5.AWVzdfbKDRg",
    "c_user": "100029952251870",
    "datr": "GPdaY0CFlBUxzJXYN7HD-ate",
    "xs": "8%3AQ8rHNGG5xLiz8A%3A2%3A1666905911%3A-1%3A5268"
}
